...
# =============================================================================
# HELPER: Send Email Notification with Inline HTML Table
# =============================================================================
def send_email_notification(metameta_name, total_views, passed_cnt, failed_cnt, failed_results=None):
    """Sends email notification featuring an inline HTML table for failed views."""
    ...
    if is_success:
        ...
        # Build HTML table rows for failed views
        table_rows = ""
    ...
    try:
        ...
        server.quit()
        logging.info("Successfully sent HTML Email notification.")
    except Exception as exc:
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if failed_count > 0:
        ...
        # Send failure notifications via Teams and HTML Email with Inline Table
