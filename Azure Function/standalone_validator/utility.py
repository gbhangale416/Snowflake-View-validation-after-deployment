...
def find_entity_meta_meta(meta, source_entity_name):
    """Finds an entity configuration in metadata."""
    if 'entities' in meta:
...
def get_entity_key_value(key, source_entity, meta):
    """Gets config key value from entity or top-level metadata."""
...
def get_snowflake_connection():
    """Establishes and returns a Snowflake cursor and connection object."""
    try:
        snowflakeConnection = {"account": 'careoregon.west-us-2.privatelink'}
